...
#define DISPLAY_COUNT NUM_MAX
#define DISPLAY_PIXEL_HEIGHT 8
#define DISPLAY_COLUMN_WIDTH 8
#define COLUMN_COUNT (NUM_MAX * DISPLAY_COLUMN_WIDTH)
#define TOTAL_PIXELS (DISPLAY_PIXEL_HEIGHT * COLUMN_COUNT)
#define SCR_LENGTH (COLUMN_COUNT + DISPLAY_COLUMN_WIDTH)

uint8_t scr[SCR_LENGTH]; // +8 for scrolled char
